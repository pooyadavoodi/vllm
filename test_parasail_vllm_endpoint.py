...
def main(args):
    ...
    data = {
        ...
        "messages": [
            {"role": "user", "content": "Write a short essay about new york city"}
        ],
        "temperature": 0.7,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="VLLM endpoint URL. Example: https://parasail-qwen25-vl-72b-instruct-28394.ohio1.sakura.saas.parasail.io/v1/chat/completions",
    )
    parser.add_argument(
        "--api-key",
        type=str,
